...
class Transformer2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(self, hidden_states, encoder_hidden_states=None, timestep=None, attn_map=None, attn_shift=False, obj_ids=None, relationship=None, return_dict: bool = True):
        ...
        for block in self.transformer_blocks:
            hidden_states, cross_attn_prob, self_prob = block(hidden_states, context=encoder_hidden_states, timestep=timestep)
        ...
        return Transformer2DModelOutput(sample=output), cross_attn_prob, self_prob
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(self, hidden_states, context=None, timestep=None):
        ...
        tmp_hidden_states, cross_attn_prob_self = self.attn1(norm_hidden_states)
        ...
        tmp_hidden_states, cross_attn_prob_cross = self.attn2(norm_hidden_states, context=context)
        hidden_states = tmp_hidden_states + hidden_states

        # 3. Feed-forward
        hidden_states = self.ff(self.norm3(hidden_states)) + hidden_states

        return hidden_states, cross_attn_prob_cross, cross_attn_prob_self
